// Проблема в ререндерах, один из варинтов решение использование хука useRef
...
export function UncontrolledFormComponentProblem() {
  ...
  return <UncontrolledFormComponent onSubmit={handleSubmit} onState1Change={setState1} onState2Change={setState2} />;
}
